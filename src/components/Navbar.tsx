                    ...
                    <div className="nav-container">
                        <div className="nav-icon-container">
                            <svg className={"nav-icon"} id="_x31__x2C_5" enable-background="new 0 0 24 24"
                                ...
                                <path
                                    d="m20.5 24h-16.75c-2.068 0-3.75-1.682-3.75-3.75v-17.5c0-1.517 1.233-2.75 2.75-2.75h12.5c1.517 0 2.75 1.233 2.75 2.75v.25h3.25c1.517 0 2.75 1.233 2.75 2.75v14.5c0 1.916-1.444 3.5-3.301 3.723-.063.018-.13.027-.199.027zm-2.5-19.5v15.75c0 1.241 1.009 2.25 2.25 2.25s2.25-1.009 2.25-2.25v-14.5c0-.689-.561-1.25-1.25-1.25zm-15.25-3c-.689 0-1.25.561-1.25 1.25v17.5c0 1.241 1.009 2.25 2.25 2.25h13.502c-.472-.627-.752-1.407-.752-2.25v-17.5c0-.689-.561-1.25-1.25-1.25z"/>
                                <path
                                    d="m8.25 9h-4.5c-.414 0-.75-.336-.75-.75v-4.5c0-.414.336-.75.75-.75h4.5c.414 0 .75.336.75.75v4.5c0 .414-.336.75-.75.75zm-3.75-1.5h3v-3h-3z"/>
                                <path
                                    d="m14.25 5.5h-2.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h2.5c.414 0 .75.336.75.75s-.336.75-.75.75z"/>
                                <path
                                    d="m14.25 8.5h-2.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h2.5c.414 0 .75.336.75.75s-.336.75-.75.75z"/>
                                <path
                                    d="m14.25 12.5h-10.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h10.5c.414 0 .75.336.75.75s-.336.75-.75.75z"/>
                                <path
                                    d="m14.25 16.25h-10.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h10.5c.414 0 .75.336.75.75s-.336.75-.75.75z"/>
                                <path
                                    d="m14.25 20h-10.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h10.5c.414 0 .75.336.75.75s-.336.75-.75.75z"/>
                            </svg>
                        </div>
                        <div className="nav-title">
                            <p>News</p>
                    ...
                    <div className="nav-container">
                        <div className="nav-icon-container">
                            <svg className={"nav-icon"} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <g>
                                    <g>
                                        <path d="M506.048,125.038c-3.748-2.834-8.609-3.749-13.133-2.469l-212,60c-6.457,1.828-10.915,7.722-10.915,14.433v203.072
                                ...
                                <g>
                                    <g>
                                        <path d="M209.305,106.481c-33.28-24.396-57.661-48.558-74.535-73.869L117.481,6.681c-3.667-5.5-10.502-7.951-16.827-6.036
